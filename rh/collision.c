...
void CollisionRate(struct Atom *atom, FILE *fp_atom)
{
  ...
  /* ----
    D.Vukadinovic: changed 22.10.2020.
    Needed for SOLVE_NE when it is in "ITERATION" mode. Reset pointer to the 
    location where collisional data are located in a file.
  --- */
  fseek(fp_atom, atom->offset_coll, SEEK_SET);
